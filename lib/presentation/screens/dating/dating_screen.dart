...
class _DatingScreenState extends State<DatingScreen> with SingleTickerProviderStateMixin {
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Wrap(
                        spacing: 6,
                        children: (profile['interests'] as List<String>).map(
                          (tag) => Container(
                        ...
                        child: GestureDetector(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              border: Border.all(color: AppColors.dating, width: 1.5),
                            ),
  ...
  Widget build(BuildContext context) {
    // ✅ تحويل إلى Column فقط (بدون Scaffold وبدون AppBar/ BottomNav)
    return SafeArea(
      child: Column(
        children: [
          // يمكنك إضافة عنوان بسيط أو تركه فارغاً (MainScreen لديه TopBar)
          Expanded(
