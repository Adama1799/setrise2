...
class _MusicScreenState extends State<MusicScreen> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    // ✅ تحويل المحتوى إلى Column مباشرة (بدون Scaffold)
    return SafeArea(
      child: Column(
        children: [
          // تبويبات الموسيقى
          ...
          Padding(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color: (track['color'] as Color).withOpacity(0.8),
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      GestureDetector(
                        onTap: () => setState(() { if (_currentTrack > 0) _currentTrack--; }),
                      ...
                      GestureDetector(
                        onTap: () => setState(() { if (_currentTrack < _tracks.length - 1) _currentTrack++; }),
                    ...
                    child: Row(
                      children: [
                        Container(
                          ...
                          child: Center(
                            child: Icon(Icons.music_note, color: isCurrent ? AppColors.music : AppColors.grey2, size: 22),
                          ),
                        ),
                        ...
                        Row(
                          children: [
                            ...
                            Text(
                              Formatters.formatCount(t['likes'] as int),
                              style: const TextStyle(color: AppColors.grey2, fontSize: 11),
                            ),
                          ],
                        ),
                      ],
