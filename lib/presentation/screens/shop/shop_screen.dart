    ...
    return Scaffold(
      ...
      body: SafeArea(child: Column(children: [
          ...
          child: Row(children: [
            ...
            Expanded(child: Container(
              ...
              child: const Row(children: [
                ...
                Text('Search products...', style: TextStyle(color: AppColors.grey2, fontSize: 13, fontFamily: 'HarmonyOS')),
              ]),
            )),
        ...
        TabBar(
          ...
          labelStyle: const TextStyle(fontSize: 14, fontWeight: FontWeight.w900, fontFamily: 'HarmonyOS'),
            ...
            itemBuilder: (_, i) {
              ...
              return GestureDetector(
                ...
                child: AnimatedContainer(
                  ...
                  child: Text(cat, style: TextStyle(color: isSelected ? AppColors.black : AppColors.white, fontSize: 12, fontWeight: FontWeight.w600, fontFamily: 'HarmonyOS')),
                ),
              );
            },
          ),
              ...
              child: Container(
                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  Padding(padding: const EdgeInsets.all(10), child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    Text(p['name'], style: const TextStyle(color: AppColors.white, fontWeight: FontWeight.bold, fontSize: 13, fontFamily: 'HarmonyOS'), maxLines: 1, overflow: TextOverflow.ellipsis),
                    Text(p['brand'], style: const TextStyle(color: AppColors.grey2, fontSize: 11, fontFamily: 'HarmonyOS')),
                    const SizedBox(height: 6),
                    Row(children: [
                      Text('\$${p['price']}', style: const TextStyle(color: AppColors.shop, fontWeight: FontWeight.bold, fontSize: 14, fontFamily: 'HarmonyOS')),
      ...
      bottomNavigationBar: Container(
        ...
        child: Row(mainAxisAlignment: MainAxisAlignment.spaceAround, children: [
          ...
          _nb(Icons.add_box_outlined, 'Sell', () {}),
...
// ===== PRODUCT DETAIL PAGE (مثل Amazon) =====
      ...
      body: CustomScrollView(slivers: [
        ...
        SliverToBoxAdapter(child: Padding(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Text(p['name'], style: const TextStyle(color: AppColors.white, fontSize: 22, fontWeight: FontWeight.bold, fontFamily: 'HarmonyOS')),
            Text(p['brand'], style: const TextStyle(color: AppColors.grey2, fontSize: 14, fontFamily: 'HarmonyOS')),
            const SizedBox(height: 12),
            Row(children: [
              ...List.generate(5, (i) => Icon(Icons.star, color: i < (p['rating'] as double).floor() ? AppColors.neonYellow : AppColors.grey, size: 18)),
              const SizedBox(width: 8),
              Text('${p['rating']} · ${Formatters.formatCount(p['sold'] as int)} sold', style: const TextStyle(color: AppColors.grey2, fontSize: 13, fontFamily: 'HarmonyOS')),
            ]),
            const SizedBox(height: 16),
            Row(crossAxisAlignment: CrossAxisAlignment.end, children: [
              Text('\$${p['price']}', style: const TextStyle(color: AppColors.shop, fontSize: 30, fontWeight: FontWeight.bold, fontFamily: 'HarmonyOS')),
              if (hasDiscount) ...[
                const SizedBox(width: 12),
            ...
            // Quantity
            Row(children: [
              const Text('Quantity:', style: TextStyle(color: AppColors.white, fontSize: 14, fontFamily: 'HarmonyOS')),
              const SizedBox(width: 12),
              Row(children: [
                ...
                Padding(padding: const EdgeInsets.symmetric(horizontal: 16),
                  child: Text('$_qty', style: const TextStyle(color: AppColors.white, fontSize: 16, fontWeight: FontWeight.bold, fontFamily: 'HarmonyOS'))),
            ...
            Container(padding: const EdgeInsets.all(14),
              ...
              child: Row(children: [
                ...
                Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  Text(p['brand'], style: const TextStyle(color: AppColors.white, fontWeight: FontWeight.bold, fontSize: 14, fontFamily: 'HarmonyOS')),
                  const Text('Official Store · ⭐ 4.9', style: TextStyle(color: AppColors.grey2, fontSize: 12, fontFamily: 'HarmonyOS')),
                ]),
                const Spacer(),
                Container(padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 6),
                  decoration: BoxDecoration(border: Border.all(color: AppColors.shop), borderRadius: BorderRadius.circular(8)),
                  child: const Text('Visit', style: TextStyle(color: AppColors.shop, fontSize: 12, fontFamily: 'HarmonyOS'))),
              ]),
            ),
            const SizedBox(height: 16),
            // Description
            const Text('Description', style: TextStyle(color: AppColors.white, fontSize: 16, fontWeight: FontWeight.bold, fontFamily: 'HarmonyOS')),
            const SizedBox(height: 8),
            Text('High-quality ${p['name']} from ${p['brand']}. Rated ${p['rating']}/5 by ${Formatters.formatCount(p['sold'] as int)} customers. Free shipping on orders over \$50.',
              style: const TextStyle(color: AppColors.grey2, fontSize: 14, height: 1.5, fontFamily: 'HarmonyOS')),
        ...
        child: Row(children: [
          GestureDetector(
            ...
            child: Container(
              ...
              child: Center(child: Text(_inCart ? '✓ Cart' : 'Add Cart',
                style: TextStyle(color: _inCart ? AppColors.shop : AppColors.white, fontSize: 13, fontWeight: FontWeight.bold, fontFamily: 'HarmonyOS'))),
            ),
          ),
          const SizedBox(width: 12),
          Expanded(child: Container(height: 52,
            ...
            child: Center(child: Text('Buy Now · \$${((p['price'] as double) * _qty).toStringAsFixed(2)}',
              style: const TextStyle(color: AppColors.black, fontSize: 15, fontWeight: FontWeight.bold, fontFamily: 'HarmonyOS'))))),
        ]),
      ),
    );
  }
