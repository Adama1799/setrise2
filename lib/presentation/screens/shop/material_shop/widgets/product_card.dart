...
Future<Color> extractDominantColor(String imageUrl) async {
  try {
    ...
    // Priority: darkMuted → muted → vibrant → dominant → fallback
...
// ─────────────────────────────────────────────────────────────
// Palette Provider — cache per product image URL
// ─────────────────────────────────────────────────────────────
                  ...
                  child: Container(
                    ...
                    child: Icon(
                      isWishlisted
                          ...
                          : Icons.favorite_border_rounded,
                      size: 18,
                      color: isWishlisted ? AppColors.error : onElegant,
                    ),
                  ),
                ),
                Stack(
                        ...
                        children: List.generate(
                          ...
                          (i) => AnimatedContainer(
                            ...
                            decoration: BoxDecoration(
                              ...
                              boxShadow: _imgPage == i
                                  ? [
                                      BoxShadow(
                                        color: elegant.withOpacity(0.5),
                                        blurRadius: 8,
                                      )
                                    ]
                                  : null,
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          const Spacer(),
                          if (p.isHot)
                            _SmBadge('🔥 HOT', AppColors.badgeHotBg),
                          if (p.isNew)
                            Padding(
                              padding: const EdgeInsets.only(left: 4),
                              child: _SmBadge('✨ NEW', AppColors.badgeNewBg),
                            ),
                          if (p.discount > 0)
                            Padding(
                              padding: const EdgeInsets.only(left: 4),
                ...
                Container(
                  ...
                  child: TabBar(
                    ...
                    tabs: [
                      ...
                      Tab(
                        text:
                            'Reviews (${reviews.isEmpty ? p.reviewCount : reviews.length})',
                      ),
                    ],
                  ),
                ),
                      ...
                      SingleChildScrollView(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            _Spec('Brand', p.brand, accent),
                            _Spec('SKU', p.id.toUpperCase(), accent),
                            _Spec('Stock', '${p.stock} units', accent),
                            _Spec('Shipping',
                                p.shippingFree ? 'Free' : '\$5.99', accent),
                              ...
                              children: [
                                Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      '${reviews.isEmpty ? p.reviewCount : reviews.length} reviews',
