        ...
        trailing: Row(
          ...
          children: [
            CupertinoButton(
              ...
              child: const Icon(CupertinoIcons.share, color: AppColors.white),
              onPressed: () {},
            ),
            CupertinoButton(
              padding: EdgeInsets.zero,
              child: const Icon(CupertinoIcons.cart, color: AppColors.white),
  ...
  Widget _bottomBar() {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border(top: BorderSide(color: AppColors.grey.withOpacity(0.2))),
      ),
      child: Row(
        children: [
          Expanded(
