    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      Padding(
        ...
        child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
          const Text('Top Stores', style: TextStyle(color: AppColors.white, fontSize: 18, fontWeight: FontWeight.bold)),
      ...
      SizedBox(
        ...
        child: ListView.builder(
          ...
          itemBuilder: (_, i) => SizedBox(width: 280, child: Padding(padding: const EdgeInsets.all(8), child: StoreCard(store: stores[i]))),
        ),
      ),
    ]);
  }
