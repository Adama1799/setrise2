// lib/presentation/screens/shop/material_shop/screens/home/widgets/home_header.dart
//
// FIX: تغيير search_Screen.dart → search_screen.dart (حساسية الأحرف)
// ──────────────────────────────────────────────────────────────
...
// ✅ تصحيح: search_Screen.dart → search_screen.dart
...
void _push(BuildContext ctx, Widget w) => Navigator.push(
    ...
    MaterialPageRoute(
        builder: (_) => ProviderScope(
            parent: ProviderScope.containerOf(ctx), child: w)));
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Padding(
      padding: const EdgeInsets.fromLTRB(
          AppDimensions.lg, AppDimensions.sm, AppDimensions.lg, 0),
      child: Row(children: [
        // Logo + title
