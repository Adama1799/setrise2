            ...
            child: Stack(children: [
              ...
              if (hasDiscount)
                Positioned(top: 8, left: 8, child: Container(
                  ...
                  child: Text('-${p.discountPercentage.round()}%', style: const TextStyle(color: AppColors.white, fontWeight: FontWeight.bold, fontSize: 11)),
                )),
              Positioned(top: 8, right: 8, child: GestureDetector(
                ...
                child: Container(
                  ...
                  child: Icon(_isFav ? CupertinoIcons.heart_fill : CupertinoIcons.heart, color: _isFav ? AppColors.neonRed : AppColors.white, size: 16),
                ),
              )),
            ]),
          ),
