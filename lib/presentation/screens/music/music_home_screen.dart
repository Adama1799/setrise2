...
class _MusicHomeScreenState extends ConsumerState<MusicHomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    // ✅ تحويل إلى Column مباشرة (بدون Scaffold)
    return Column(
      children: [
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return GestureDetector(
                        onTap: () => ref.read(musicProvider.notifier).playTrack(track),
                        child: Container(
                          width: 140,
                          ...
                          child: Stack(
                            ...
                            children: [
                              ClipRRect(
                                borderRadius: BorderRadius.circular(12),
                                child: Image.network(track.albumCover, fit: BoxFit.cover),
                              ),
                              Container(
                                decoration: BoxDecoration(
                                  borderRadius: BorderRadius.circular(12),
                              ...
                              Positioned(
                                ...
                                child: Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    Text(track.title, style: AppTypography.labelSmall.copyWith(color: AppColors.white), maxLines: 1, overflow: TextOverflow.ellipsis),
                                    Text(track.artist, style: AppTypography.caption.copyWith(color: AppColors.white.withOpacity(0.7)), maxLines: 1, overflow: TextOverflow.ellipsis),
                                  ],
                                ),
                              ),
                              Positioned(
                                ...
                                child: Container(
                                  width: 40, height: 40,
                                  decoration: BoxDecoration(shape: BoxShape.circle, color: AppColors.music.withOpacity(0.9)),
                ...
                Padding(
                  padding: const EdgeInsets.all(16),
                  child: Text('All Tracks', style: AppTypography.h3),
                ),
                ...musicState.tracks.map(
                  (track) => TrackCard(
                    track: track,
                    onTap: () => ref.read(musicProvider.notifier).playTrack(track),
                    onLikeTap: () => ref.read(musicProvider.notifier).toggleLike(track.id),
                  ),
                ),
              ],
            ),
