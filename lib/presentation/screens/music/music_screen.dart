      ...
      body: SafeArea(child: Column(children: [
        ...
        Padding(padding: const EdgeInsets.symmetric(horizontal: 14, vertical: 10),
          child: Row(children: [
            ...
            const Spacer(),
            const Text('Music', style: TextStyle(color: AppColors.white, fontSize: 18, fontWeight: FontWeight.w900, fontFamily: 'HarmonyOS')),
            const Spacer(),
        ...
        TabBar(
          ...
          labelStyle: const TextStyle(fontSize: 13, fontWeight: FontWeight.w700, fontFamily: 'HarmonyOS'),
        ...
        Padding(padding: const EdgeInsets.symmetric(horizontal: 16),
          child: Container(
            ...
            child: Column(children: [
              ...
              Text(track['title'], style: const TextStyle(color: AppColors.white, fontSize: 20, fontWeight: FontWeight.bold, fontFamily: 'HarmonyOS')),
              const SizedBox(height: 4),
              Text(track['artist'], style: const TextStyle(color: AppColors.music, fontSize: 14, fontFamily: 'HarmonyOS')),
              Text(track['genre'], style: const TextStyle(color: AppColors.grey2, fontSize: 12, fontFamily: 'HarmonyOS')),
              const SizedBox(height: 16),
              // Progress
              SliderTheme(
              ...
              child: Container(
                ...
                child: Row(children: [
                  ...
                  Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    Text(t['title'], style: TextStyle(color: isCurrent ? AppColors.music : AppColors.white, fontWeight: isCurrent ? FontWeight.bold : FontWeight.normal, fontSize: 14, fontFamily: 'HarmonyOS')),
                    Text(t['artist'], style: const TextStyle(color: AppColors.grey2, fontSize: 12, fontFamily: 'HarmonyOS')),
                  ])),
                  Text(t['duration'], style: const TextStyle(color: AppColors.grey2, fontSize: 12, fontFamily: 'HarmonyOS')),
                  const SizedBox(width: 8),
                  Row(children: [
                    const Icon(Icons.favorite, color: AppColors.neonRed, size: 14),
                    const SizedBox(width: 3),
                    Text(Formatters.formatCount(t['likes'] as int), style: const TextStyle(color: AppColors.grey2, fontSize: 11, fontFamily: 'HarmonyOS')),
                  ]),
                ]),
              ),
            );
